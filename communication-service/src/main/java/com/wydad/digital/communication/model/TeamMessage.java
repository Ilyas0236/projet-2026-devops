 ...
 * catégorie. L'adhésion au groupe n'est pas stockée : elle est DÉDUITE
 * du roster interrogé sur sports-service (API interne), ce qui garantit
 * qu'un membre parti de l'équipe n'a plus accès à l'historique.
 */
@Entity
...
public class TeamMessage {
    ...
    /** Groupe = sportType + category (ex. FOOTBALL U19), en STRING pour découplage. */
