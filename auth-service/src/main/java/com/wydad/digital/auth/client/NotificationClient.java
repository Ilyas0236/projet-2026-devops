...
/**
 * Client best-effort vers notification-service (Phase 1 ter) : prévient le
 * membre quand l'admin valide ou refuse son compte. Une panne de
 * notification ne doit JAMAIS faire échouer la validation/refus côté admin.
 */
@Slf4j
@Component
