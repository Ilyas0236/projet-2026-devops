...
/**
 * Client best-effort vers notification-service (même mécanisme que les
 * autres services). Une panne de notification ne doit JAMAIS faire échouer
 * la publication des résultats d'une élection.
 */
@Slf4j
@Component
