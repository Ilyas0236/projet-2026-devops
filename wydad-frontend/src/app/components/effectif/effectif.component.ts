  ...
  loadPlayers() {
    this.api.getJoueursBySport(this.selectedSport).subscribe({
      ...
      error: () => {
        ...
        this.players = [
          { nom: 'Yahya Jabrane', numero: 5, poste: 'Milieu', age: 32, matchsJoues: 150, buts: 12, passes: 8 },
          { nom: 'Ayoub El Amloud', numero: 22, poste: 'Défenseur', age: 29, matchsJoues: 120, buts: 5, passes: 15 },
          { nom: 'Youssef El Motie', numero: 32, poste: 'Gardien', age: 28, matchsJoues: 60, buts: 0, passes: 1 },
          { nom: 'Hamdou El Houni', numero: 10, poste: 'Attaquant', age: 30, matchsJoues: 30, buts: 8, passes: 5 }
        ];
      }
    });
  }
