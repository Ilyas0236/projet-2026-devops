...
/**
 * Client best-effort vers notification-service (réutilise le mécanisme
 * existant, cf. ticket/shop/gamification). Une panne de notification ne
 * doit JAMAIS faire échouer la création d'une convocation.
 */
@Slf4j
@Component
