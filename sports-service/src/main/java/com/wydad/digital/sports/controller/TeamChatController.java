...
/**
 * Phase 4 — API REST du chat de groupe : historique persisté, membres,
 * et fallback d'envoi si le WebSocket est coupé. Mêmes règles d'adhésion
 * que le canal WS (revérifiées côté service).
 */
@RestController
...
public class TeamChatController {
    ...
    @PreAuthorize("hasAnyRole('JOUEUR','STAFF','ENTRAINEUR','ADMIN')")
    public ResponseEntity<List<TeamChatService.GroupMember>> members(
            @PathVariable SportType sport,
            @PathVariable Category category) {
